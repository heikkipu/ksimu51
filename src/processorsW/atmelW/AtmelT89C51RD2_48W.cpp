...
void AtmelT89C51RD2_48W::saveWorkDataToFile_VirtualPart(QDataStream& saveFileStream)
{
	AtmelT89C51RD2_32W::saveWorkDataToFile_VirtualPart(saveFileStream);
...
void AtmelT89C51RD2_48W::readWorkDataFromFile_VirtualPart(QDataStream& readFileStream,
													  std::function<bool( QDataStream& readFileStream)>funcHandleUnknownIndexRead)
{
	AtmelT89C51RD2_32W::readWorkDataFromFile_VirtualPart(readFileStream, funcHandleUnknownIndexRead);
