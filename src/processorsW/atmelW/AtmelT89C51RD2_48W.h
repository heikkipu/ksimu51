...
***************************************************************************/
#ifndef T89C51RD2_48W_H
#define T89C51RD2_48W_H

#include "../I51BaseW.h"
#include "AtmelT89C51RD2_32W.h"

#include "../../processors/Atmel/T89C51RD2_48.h"
class T89C51RD2_48;

class AtmelT89C51RD2_48W : virtual public I51BaseW, public AtmelT89C51RD2_32W
{
	Q_OBJECT
	public:
		AtmelT89C51RD2_48W(QWidget* parent, char const * name, int wflags, int const  index, int const  type);
		~AtmelT89C51RD2_48W();
