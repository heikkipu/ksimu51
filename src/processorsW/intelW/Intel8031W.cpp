...
Intel8031W::Intel8031W(QWidget* parent, char const * name, int wflags, int const  index, int const  type) : I51BaseW(parent, name, wflags, index, type)
{
}

Intel8031W::~Intel8031W()
{
}


void Intel8031W::saveWorkDataToFile_VirtualPart(QDataStream& saveFileStream)
{
...
void Intel8031W::readWorkDataFromFile_VirtualPart(QDataStream& readFileStream,
