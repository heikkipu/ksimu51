...
void Intel8032W::saveWorkDataToFile_VirtualPart(QDataStream& saveFileStream)
{
	I51BaseInternalIRAMW::saveWorkDataToFile_VirtualPart(saveFileStream);
	I51BaseTimer2W::saveWorkDataToFile_VirtualPart(saveFileStream);
...
void Intel8032W::readWorkDataFromFile_VirtualPart(QDataStream& readFileStream,
												  std::function<bool( QDataStream& readFileStream)>funcHandleUnknownIndexRead)
{
	...
	I51BaseTimer2W::readWorkDataFromFile_VirtualPart(readFileStream, funcHandleUnknownIndexRead);
